...
?> 
        <label>Placa: <?php echo $_SESSION['policia'] ?></label>
<?php
    }
?>
    </div>
    <div id="cabeceraAdmin" class="info-cabecera">
...
?>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <input id="eInputCerrarSesion" class="pointer" type="submit" name="cerrar_sesion" value="CERRAR SESIÓN">
            <label for="eInputCerrarSesion" class="pointer">
